...
(use-package lsp-mode
  ...
  :config
  (lsp-register-client
   (make-lsp-client :new-connection (lsp-stdio-connection '("/home/louis/.opam/a/bin/ocamlmerlin-lsp"))
...
(add-to-list 'org-structure-template-alist '("w" . "src emacs-lip"))
#+end_src

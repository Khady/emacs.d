...
#+BEGIN_SRC emacs-lisp
(setq-local my/default-theme 'doom-tomorrow-night)
...
(use-package merlin-eldoc
  :after merlin
  :load-path "~/Code/github/merlin-eldoc"
  :custom
...
If no face is setup for ~merlin-type-face~, ~caml~ is required because
it will be set to ~caml-types-expr-face~.
...
(use-package tuareg
  ...
  :hook (tuareg-mode . (lambda () (setq-local comment-continue "  ")))) ; TODO: should it be in custom instead?
#+END_SRC
...
(use-package smartparens
  ...
  (defun my/enable-smartparens-prog ()
    "Enable all smartparens mode + keymap."
    (interactive)
    (smartparens-mode)
  ...
  (defun my/enable-smartparens-text ()
    ...
    (show-smartparens-mode))
  :hook
  (prog-mode . my/enable-smartparens-prog)
  (text-mode . my/enable-smartparens-text))
#+END_SRC
